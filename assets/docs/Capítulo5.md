...
| User Story ID | User Story Title                       | Task ID | Task Title | Description | Estimation (Hours) | Assigned To | Status |
|---------------|----------------------------------------|---------|------------|-------------|--------------------|-------------|--------|
| US07          | Registro de nueva cita                 |         |            |             |                    |            |        |
| US02          | Gestión de citas                       |         |            |             |                    |             |        |
| US04          | Herramienta de comunicación            |         |            |             |                    |             |        |
| US05          | Generación de informes                 |         |            |             |                    |             |        |
| US06          | Seguridad de los datos médicos         |         |            |             |                    |             |        |
| US09          | Disponibilidad de horarios             |         |            |             |                    |             |        |
| US12          | Confirmación de cita                   |         |            |             |                    |             |        |
| US10          | Recordatorio de citas                  |         |            |             |                    |             |        |
| US11          | Cancelación y re-agendamiento de citas |         |            |             |                    |             |        |
| US15          | Actualización de Planes de Tratamiento |         |            |             |                    |             |        |
| US15          | Actualización de Planes de Tratamiento |         |            |             |                    |             |        |
| US19          | Acceso rápido al historial médico del paciente |         |            |             |                    |             |        |
| US15          | Visualización detallada del historial médico |         |            |             |                    |             |        |
