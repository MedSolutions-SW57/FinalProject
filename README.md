...
|      US06       |Desarrollo de Endpoints para la obtener Resultados Médicos de Doctores y Pacientes| Como desarrollador que está construyendo una aplicación web médica, quiero obtener los resultados de los exámenes médicos para los doctores y pacientes a través de endpoints API,para que los doctores puedan ver los resultados de los exámenes médicos de sus pacientes y los pacientes puedan ver su historial de exámenes médicos sin tener que buscar manualmente esta información.  |<p>****</p><p>- </p><p>- </p><p>- .</p>|E01|
...
<table>
	<tbody>
		...
		<tr>
			...
			<td rowspan="2">Desarrollo de Endpoints para la obtener Resultados Médicos de Doctores y Pacientes</td>
			<td>T09</td>
