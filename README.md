...
|      US06       |            Consulta de exámenes médicos             |                                                                Como desarrollador, quiero obtener los exámenes médicos a través de la API, para poder mostrar o procesar la información de los exámenes.                                                                 | <p>**Escenario1:Obtener el exámen médico de una paciente con id específico**</p>-Given que el endpoint "/api/v1/request-result/patient/{patientId}" está disponible,<p> </p>-When se envía una solicitud GET con un patientId válido,<p> </p>-Then se recibe una respuesta con el estado 200,<p><p>-And una lista de exámenes médicos para ese paciente está incluida en el cuerpo de la respuesta.</p> </p><p>**Escenario2:Obtener el exámen médico de una paciente con id específico no existente**</p><p>-Given que el endpoint "/api/v1/request-result/patient/{patientId}" está disponible,</p><p>-When se envía una solicitud GET con un patientId,</p><p>-And no se encuentra ningún paciente con aquel Id<p>-Then se recibe una respuesta con el estado 404</p><p>-And un mensaje de error está incluido en el cuerpo de la respuesta indicando "Paciente no encontrado".</p></p> |            E01            |
